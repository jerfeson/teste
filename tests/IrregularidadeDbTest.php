...
class IrregularidadeDbTest extends PHPUnit_Extensions_Database_TestCase
{
    /**
    ...
    {
        return $this->createMySQLXMLDataSet('../../data/irregularidade_fixture.xml');
    }
     ...
     * @test
     */
    public function alterarIrregularidade()
    {
        ...
        $this->webDriver->findElement(WebDriverBy::id('motivo'))->clear()->sendKeys('TESTE SNOW');
        $this->webDriver->findElement(WebDriverBy::id('confirmar'))->click();
	    ...
	    $expectedTable = $this->createMySQLXMLDataSet('../../data/irregularidade_expected.xml')->getTable('codigoirregularidade');
	     
	    $queryTable = $this->getConnection()->createQueryTable(
	        'codigoirregularidade',
	        'SELECT * FROM codigoirregularidade'
        );
